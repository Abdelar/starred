...
> Axios is a promise base library that a lot of Vue JS users use to do things like Ajax.
[See full documentation](https://github.com/axios/axios)

- **Moment**

> Parse, validate, manipulate, and display dates and times in JavaScript.[See full documentation](https://momentjs.com/docs/)
